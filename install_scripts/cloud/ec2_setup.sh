...
###########
# Taken from https://github.com/sequenceiq/hadoop-cloud-scripts/blob/depricated/silent-install.sh
# Apache License in License folder
###########
# Changed 1.x to 2.x line 
# Added installer
####
...
curl -so /etc/yum.repos.d/ambari.repo http://public-repo-1.hortonworks.com/HDP/centos6/2.x/GA/2.2.0.0/hdp.repo
